...
- [Indicative Conditionals](#indicative-conditionals)
  ...
  - [Future More Vivid / Future Simple](#future-more-vivid--future-simple)
  - [Practice Opportunity 1](#practice-opportunity-1)
- [Subjunctive Conditionals](#subjunctive-conditionals)
  - [Past Contrary-to-Fact](#past-contrary-to-fact)
  - [Present Contrary-to-Fact](#present-contrary-to-fact)
  - [Future Less Vivid](#future-less-vivid)
...
A condition may be composed of different types of protases and apodoses or, sometimes, even entire other grammatical constructions like [hortatory subjunctives](orders#hortatory-subjunctive) or [imperatives](orders#imperative-mood). In such cases, analyze each half of the condition on its own terms and translate accordingly before putting the two halves together. For example:
