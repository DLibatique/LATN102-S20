...
- [Types of Participles](#types-of-participles):
  - [Present Active Participle](#present-active-participle)
    - [Deponents](#present-active-participle-of-deponents)
  ...
  - [Future Active Participle](#future-active-participle)
    ...
    - [Deponents](#future-active-participle-and-infinitive-of-deponents)
  - [Future Passive Participle](#future-passive-participle)
  - [Practice Opportunity 1](#practice-opportunity-1)
- [Relative Tense and Translating Participles](#relative-tense-and-translating-participles)
...
- *videō cīvēs regem laudātūrōs esse.* I see that the citizens are going to praise the king.
...
- hortātūrus, "about to exhort"
- veritūrus, "about to fear"
...
- A **perfect** participle indicates an action that is **completed** by the time of the action of the main verb.
...
<button onclick="toggleDisplay('ex1')">Click here to toggle the answer:</button> <span style="display: none;" id="ex1">having been sung, perfect passive; going to learn, future active</span>
...
- *mīlite flūmen aspiciente hostēs castra cēpērunt.* **While the soldier was watching the river**, the enemies seized the camp.
- *mīlite flūmen aspiciente hostēs castra cēpērunt.* **Because the soldier was watching the river**, the enemies seized the camp.

- *eī epistulam mittēmus verbīs eius lectīs.* We will send him a letter **after his words are read**.
- *eī epistulam mittēmus verbīs eius lectīs.* We will send him a letter **after we read his words**.\*
